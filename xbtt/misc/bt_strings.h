...
const std::string bts_hidden_torrent = "access denied, hidden torrent";
const std::string bts_enabled_user = "yours account disabled";
const std::string bts_parked_user = "your account parked, please read the faq";
