...
void Cconfig::fill_maps(const Cconfig* v)
{
	...
	}
	{
		...
		{
			"column_files_completed", &m_column_files_completed, "downloads",
			"column_files_fid", &m_column_files_fid, "id",
			...
			"table_files", &m_table_files, "torrents",
			"table_files_users", &m_table_files_users, "peers",
			"table_scrape_log", &m_table_scrape_log, "",
			"table_users", &m_table_users, "users",
