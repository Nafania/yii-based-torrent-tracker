...
class ARedisChannel extends ARedisIterableEntity {
	...
	public function subscribe() {
		...
		$this->getConnection()->subscribe(array($this->name),array($this,"receiveMessage"));
		return $this;
	}
	/**
	...
	public function unsubscribe() {
		...
		$this->getConnection()->unsubscribe(array($this->name));
		return $this;
	}
	...
	public function publish($message) {
		...
		$this->_data[] = $message;
		return $this->getConnection()->publish($this->name,$message);
	}
	/**
