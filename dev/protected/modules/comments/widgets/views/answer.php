...
<div class="answerBlock">
    ...
    $js = <<<JS
var validateForm = function(form,data,hasError) {
...
JS;
    Yii::app()->getClientScript()->registerScript('validateCommentsForm', $js);
        ...
        echo '<div>' . $form->labelEx($comment,
                ...
                array(
                    ...
                    'title' => Yii::t('torrentsModule.common',
                            'Если ваш комментарий относится к конкретному торренту (например, у вас вопрос по качеству материала), то выберите его в этом списке.'),
