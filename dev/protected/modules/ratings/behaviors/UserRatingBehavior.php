...
class UserRatingBehavior extends RatingBehavior {
	...
	public function calculateRating () {
		 ...
		 * ( K5 * Кол-во торрентов + K6 * кол-во комментариев + К7 * кол-во записей / К ) + K8 * сумма скачиваний торрентов + K9 * сумма рейтингов комментариев + К10 * сумма рейтингов записей в блоге;
		 */
		/**
