...
class AuthAssignmentRevokeColumn extends AuthAssignmentColumn
{
	...
	protected function renderDataCellContent($row, $data)
	{
		if ($this->userId !== null)
		{
			echo CHtml::link(Yii::t('AuthModule.main', 'Revoke'), array('revoke', 'itemName' => $data['name'], 'userId' => $this->userId),  array('rel' => 'tooltip', 'title' => Yii::t('AuthModule.main', 'Revoke')));

			/*$this->grid->controller->widget('zii.widgets.grid.CButton', array(
				'type' => 'link',
				'size' => 'mini',
				'icon' => 'remove',
