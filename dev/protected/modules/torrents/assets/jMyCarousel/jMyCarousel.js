...
(function ($) {                  // Compliant with jquery.noConflict()
    $.fn.jMyCarousel = function (o) {
        ...
        return this.each(function () {                           // Returns the element collection. Chainable.
            ...
            var liSize = o.vertical ? height(li) : ( o.width == null ? width(li) : o.width );   // Full li size(incl margin)-Used for animation
...
//            console.log("ulSize=" + ulSize + "; nbElts=" + nbElts + "; liSize=" + liSize + "; liSizeV=" + liSizeV + "; curr=" + curr + "; visible : " + liSize * v); // debug
    ...
    function width(el) {
        var elem = $(el[0]);
        var totalWidth = el[0].offsetWidth;
