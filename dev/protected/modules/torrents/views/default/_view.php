...
<div class="media">
	<?php
	$img = CHtml::image($data->getImageUrl(100, 0), $data->getTitle(), array('class' => 'media-object img-polaroid'));
	...
	<div class="media-body">
        ...
        <p>
	        <strong><?php echo CHtml::link($data->category->getTitle(), array('/torrents/default/index', 'category' => $data->category->getTitle())) ?></strong>
	        <?php
