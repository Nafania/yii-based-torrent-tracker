...
?>
	...
	<div class="container-flexible">
        ...
        <div class="column span-24">
            <h3><?php echo Yii::t('GroupsModule.common', 'Создание группы') ?></h3>
            <fieldset class="module">
              ...
              echo 'errors';
	            ...
	            <div class="row <?php if ( $model->getError('blocked') ) {
              echo 'errors';
             } ?>">
                 <div class="column span-4"><?php echo $form->labelEx($model, 'blocked'); ?></div>
                 <div class="column span-16 span-flexible">
                     <?php echo $form->checkBox($model, 'blocked'); ?>
                  <ul class="errorlist">
                         <li><?php echo $form->error($model, 'blocked'); ?></li>
                     </ul>
                 </div>
             </div>
